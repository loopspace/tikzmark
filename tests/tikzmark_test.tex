...
\node at (0,-1.5) {\(\displaystyle S_n = \subnode{a}{\sum_{k=0}^n r^k} = \frac{r^{n+1} - 1}{r-1} \)};
\draw[->] (a.south east) to[bend left] (a.south west);
\node[fit=(a),draw,inner sep=0pt,node contents={}];
\end{tikzpicture}

\item Text style
\begin{tikzpicture}[remember picture,baseline=-1]
\node {\(S_n = \sum_{k=0}^n r^k = \frac{r^{n+1} - 1}{r-1} \)};
\node at (0,-1.5) {\(S_n = \subnode{a}{\sum_{k=0}^n r^k} = \frac{r^{n+1} - 1}{r-1} \)};
\draw[->] (a.south east) to[bend left] (a.south west);
\node[fit=(a),draw,inner sep=0pt,node contents={}];
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture,baseline=-1]
\node {\(S_n = \sum_{k=0}^n r^k = \frac{r^{n+1} - 1}{r-1} \)};
\node at (0,-1.5) {\(S_n = \sum_{k=0}^{\subnode{a}{n}} r^k = \frac{r^{n+1} - 1}{r-1} \)};
\draw[->] (a.south east) to[bend left] (a.south west);
\node[fit=(a),draw,inner sep=0pt,node contents={}];
\end{tikzpicture}
...
\node at (0,-1.5) {\(\scriptstyle S_n = \sum_{k=0}^{\subnode{a}{n}} r^k = \frac{r^{n+1} - 1}{r-1} \)};
\draw[->] (a.south east) to[bend left] (a.south west);
\node[fit=(a),draw,inner sep=0pt,node contents={}];
\end{tikzpicture}
